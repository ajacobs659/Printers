...
if ($printDriverExists)
{
Add-Printer -Name "ROOM-11" -PortName $portName -DriverName $DriverName
}
else
{
Write-Warning "Printer Driver not installed"
...
################################
$PSScriptRoot = Split-Path -Parent -Path $MyInvocation.MyCommand.Definition
$drivername = "Kyocera ECOSYS MA5500ifx KX"
...
#Staging Drivers   #
###################
C:\Windows\System32\pnputil.exe /add-driver "$psscriptroot\64bit1\OEMSETUP.INF" /install
...
################################
$PSScriptRoot = Split-Path -Parent -Path $MyInvocation.MyCommand.Definition
$drivername = "Kyocera ECOSYS MA5500ifx NW-FAX"
$portName = "IP_192.168.81.250-2"
$PortAddress = "192.168.81.250"
...
#Staging Drivers   #
###################
C:\Windows\System32\pnputil.exe /add-driver "$psscriptroot\64bit2\OEMSETUP.INF" /install
